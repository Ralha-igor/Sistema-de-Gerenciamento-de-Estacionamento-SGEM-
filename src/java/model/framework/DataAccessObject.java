...
// =======================
    private void insert() {
        try {
            ...
            throw new RuntimeException("ERRO_INTEGRIDADE", e);
        } catch (SQLException e) {
            throw new RuntimeException("ERRO_SQL", e);
        } catch (Exception e) {
            throw new RuntimeException("ERRO_DESCONHECIDO", e);
        }
    }
...
//   GET ALL
// =======================
    public <T extends DataAccessObject> ArrayList<T> getAllTableEntities() {
        try {
